...
const buttonVariants = cva(
  "inline-flex items-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors disabled:pointer-events-none disabled:[&_svg]:fill-icon-disabled",
  {
    variants: {
      variant: {
        primary:
          "justify-center text-text-button-primary [&_svg]:fill-icon-button-primary bg-button-surface-primary disabled:text-text-disabled disabled:bg-button-surface-disabled hover:bg-primary-400 dark:hover:bg-primary-600 focus-visible:outline-hidden ring-offset-primary-200 focus-visible:ring-primary-200 dark:focus-visible:ring-primary-700 focus-visible:ring-offset-0 focus-visible:ring-2 active:bg-primary-600 dark:active:bg-primary-400",
        secondary:
        ...
        ghost:
          "justify-center text-text-action disabled:text-text-disabled dark:hover:bg-primary-900 dark:hover:text-primary-50 hover:bg-primary-25 focus-visible:outline-hidden focus-visible:ring-primary-200 dark:focus-visible:ring-primary-700 focus-visible:ring-offset-0 focus-visible:ring-2 active:bg-primary-50 dark:active:bg-primary-850 dark:active:text-primary-50",
        warning:
        ...
        input:
          "justify-between text-left ring-none flex h-8 rounded-lg border border-form-border-primary bg-form-surface-primary p-2 text-sm ring-inset transition-colors file:text-sm file:font-medium placeholder:text-text-secondary hover:bg-neutral-25 focus-visible:border-border-action focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary-200 disabled:cursor-not-allowed disabled:border-form-border-disabled disabled:bg-form-surface-disabled disabled:text-text-disabled dark:hover:bg-form-surface-disabled dark:hover:bg-neutral-800 dark:focus-visible:ring-primary-700 focus-visible:[&_svg]:fill-icon-tertiary disabled:[&_svg]:fill-icon-disabled",
      },
      size: {
        default: "h-8 px-4",
        icon: "h-8 px-1.5",
